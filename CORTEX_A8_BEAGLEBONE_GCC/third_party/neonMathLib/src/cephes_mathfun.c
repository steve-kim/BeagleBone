...
** under zlib license. The file contains function taken from the Cephes
** Maths Library.
**
...
**       The Cephes library maths functions cephes_sinf,cephes_cosf, cephes_logf
**       and cephes_expf were originally defined in neon_mathfun_test.c referred from
**       the following link http://gruntthepeon.free.fr/ssemath/neon_mathfun_test.c
