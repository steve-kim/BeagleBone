...
//According to the Cortex A Programmer's Reference Manual, the Cortex A-8 does not have a GIC. I am commenting out this check for now.
#if 0
...
{
uint32_t ulAPSR;
//According to the Cortex A Programmers Reference Manual, the Cortex A-8 does not contain a GIC. I am commenting this code out for now.
#if 0
